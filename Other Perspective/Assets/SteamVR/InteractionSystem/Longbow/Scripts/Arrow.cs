...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Arrow : MonoBehaviour
    {
        ...
        public static UnityEvent shootTextEvent;

        private Vector3 prevPosition;
        private Quaternion prevRotation;
        private Vector3 prevVelocity;
        private Vector3 prevHeadPosition;
        private ShootingText shootingText;
        ...
        void Start()
        {
            if (shootTextEvent == null)
                shootTextEvent = new UnityEvent();
        ...
        void OnCollisionEnter(Collision collision)
        {
            if (inFlight)
            {
                ...
                if (hitBalloon)
                {
                    ...
                    if (collision.collider.gameObject.GetComponent<Balloon>().GetColor().Equals(Balloon.BalloonColor.Yellow))
                        shootTextEvent.Invoke();
